...
import com.zfdang.zsmth_android.BoardTopicFragment.OnListFragmentInteractionListener;
...
public class BoardTopicRecyclerViewAdapter extends RecyclerView.Adapter<BoardTopicRecyclerViewAdapter.ViewHolder> {
    ...
    public BoardTopicRecyclerViewAdapter(List<Topic> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
